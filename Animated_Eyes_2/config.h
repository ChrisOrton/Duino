...
#define TFT1_CS 12         // TFT 1 chip select pin (set to -1 to use TFT_eSPI setup)
...
#define EYE_1_XPOSITION  96 // x shift for eye 1 image on display
#define EYE_2_XPOSITION  96 // x shift for eye 2 image on display
