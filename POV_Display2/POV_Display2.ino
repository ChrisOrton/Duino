...
char textString[] = " MOMENTARILY PICTURESQUE ";//enter your text here
...
void setup() {
  ...
  characterI = sizeof(textString) - 1;
}
...
for (int characterI = sizeof(textString) - 1; characterI > -1; characterI--) {
      Display(textString[characterI]);
    }
